...
const ACTION_OPTIONAL_INPUT_KEY_LIST = ['extractionEndPoint'] as const;

const ACTION_INPUT_KEY_LIST = [...ACTION_REQUIRED_INPUT_KEY_LIST, ...ACTION_OPTIONAL_INPUT_KEY_LIST] as const;
